...
public class IncomeCreatedEvent extends ApplicationEvent {
    ...
    public IncomeCreatedEvent(Object source, String incomeId, String userId, String sourceName, BigDecimal amount, String currencyCode, LocalDateTime incomeDate) {
        super(source);
